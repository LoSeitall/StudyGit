...
public class SelectSellOrderDeleteServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("content/institution-listsellorderdelete.jsp").forward(request, response);
	}
